...
enum opt_code
{
  ...
  /* OPT_ftail_call_workaround = 995, */     /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 996,          /* -ftail-call-workaround= */
  ...
  OPT_m128bit_long_double = 1152,            /* -m128bit-long-double */
  OPT_m16 = 1153,                            /* -m16 */
  OPT_m32 = 1154,                            /* -m32 */
  OPT_m3dnow = 1155,                         /* -m3dnow */
  OPT_m3dnowa = 1156,                        /* -m3dnowa */
  OPT_m64 = 1157,                            /* -m64 */
  OPT_m80387 = 1158,                         /* -m80387 */
  OPT_m8bit_idiv = 1159,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1160,             /* -m96bit-long-double */
  OPT_mabi_ = 1161,                          /* -mabi= */
  OPT_mabm = 1162,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1163,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1164,                 /* -maddress-mode= */
  OPT_madx = 1165,                           /* -madx */
  OPT_maes = 1166,                           /* -maes */
  OPT_malign_data_ = 1167,                   /* -malign-data= */
  OPT_malign_double = 1168,                  /* -malign-double */
  OPT_malign_functions_ = 1169,              /* -malign-functions= */
  OPT_malign_jumps_ = 1170,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1171,                  /* -malign-loops= */
  OPT_malign_stringops = 1172,               /* -malign-stringops */
  OPT_mandroid = 1173,                       /* -mandroid */
  OPT_march_ = 1174,                         /* -march= */
  OPT_masm_ = 1175,                          /* -masm= */
  OPT_mavx = 1176,                           /* -mavx */
  OPT_mavx2 = 1177,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1178,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1179,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1180,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1181,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1182,                      /* -mavx512bw */
  OPT_mavx512cd = 1183,                      /* -mavx512cd */
  OPT_mavx512dq = 1184,                      /* -mavx512dq */
  OPT_mavx512er = 1185,                      /* -mavx512er */
  OPT_mavx512f = 1186,                       /* -mavx512f */
  OPT_mavx512ifma = 1187,                    /* -mavx512ifma */
  OPT_mavx512pf = 1188,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1189,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1190,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1191,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1192,                        /* -mbionic */
  OPT_mbmi = 1193,                           /* -mbmi */
  OPT_mbmi2 = 1194,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1195,                  /* -mbranch-cost= */
  OPT_mcld = 1196,                           /* -mcld */
  OPT_mclflushopt = 1197,                    /* -mclflushopt */
  OPT_mclwb = 1198,                          /* -mclwb */
  OPT_mclzero = 1199,                        /* -mclzero */
  OPT_mcmodel_ = 1200,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1201, */                    /* -mcpu= */
  OPT_mcrc32 = 1202,                         /* -mcrc32 */
  OPT_mcx16 = 1203,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1204,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1205,            /* -mdump-tune-features */
  OPT_mf16c = 1206,                          /* -mf16c */
  OPT_mfancy_math_387 = 1207,                /* -mfancy-math-387 */
  OPT_mfentry = 1208,                        /* -mfentry */
  OPT_mfma = 1209,                           /* -mfma */
  OPT_mfma4 = 1210,                          /* -mfma4 */
  OPT_mforce_drap = 1211,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1212,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1213,                       /* -mfpmath= */
  OPT_mfsgsbase = 1214,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1215,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1216, */              /* -mfused-madd */
  OPT_mfxsr = 1217,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1218,             /* -mgeneral-regs-only */
  OPT_mglibc = 1219,                         /* -mglibc */
  OPT_mhard_float = 1220,                    /* -mhard-float */
  OPT_mhle = 1221,                           /* -mhle */
  OPT_miamcu = 1222,                         /* -miamcu */
  OPT_mieee_fp = 1223,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1224,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1225,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1226,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1227,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1228,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1229, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1230,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1231,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1232,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1233,                /* -mlong-double-80 */
  OPT_mlwp = 1234,                           /* -mlwp */
  OPT_mlzcnt = 1235,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1236,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1237,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1238,                  /* -mmitigate-rop */
  OPT_mmmx = 1239,                           /* -mmmx */
  OPT_mmovbe = 1240,                         /* -mmovbe */
  OPT_mmpx = 1241,                           /* -mmpx */
  OPT_mms_bitfields = 1242,                  /* -mms-bitfields */
  OPT_mmusl = 1243,                          /* -mmusl */
  OPT_mmwaitx = 1244,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1245,            /* -mno-align-stringops */
  OPT_mno_default = 1246,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1247,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1248,                  /* -mno-push-args */
  OPT_mno_red_zone = 1249,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1250,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1251,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1252,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1253,                          /* -mpc32 */
  OPT_mpc64 = 1254,                          /* -mpc64 */
  OPT_mpc80 = 1255,                          /* -mpc80 */
  OPT_mpclmul = 1256,                        /* -mpclmul */
  OPT_mpcommit = 1257,                       /* -mpcommit */
  OPT_mpku = 1258,                           /* -mpku */
  OPT_mpopcnt = 1259,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1260,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1261,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1262,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1263,                        /* -mprfchw */
  OPT_mpush_args = 1264,                     /* -mpush-args */
  OPT_mrdpid = 1265,                         /* -mrdpid */
  OPT_mrdrnd = 1266,                         /* -mrdrnd */
  OPT_mrdseed = 1267,                        /* -mrdseed */
  OPT_mrecip = 1268,                         /* -mrecip */
  OPT_mrecip_ = 1269,                        /* -mrecip= */
  OPT_mrecord_mcount = 1270,                 /* -mrecord-mcount */
  OPT_mred_zone = 1271,                      /* -mred-zone */
  OPT_mregparm_ = 1272,                      /* -mregparm= */
  OPT_mrtd = 1273,                           /* -mrtd */
  OPT_mrtm = 1274,                           /* -mrtm */
  OPT_msahf = 1275,                          /* -msahf */
  OPT_msgx = 1276,                           /* -msgx */
  OPT_msha = 1277,                           /* -msha */
  OPT_mskip_rax_setup = 1278,                /* -mskip-rax-setup */
  OPT_msoft_float = 1279,                    /* -msoft-float */
  OPT_msse = 1280,                           /* -msse */
  OPT_msse2 = 1281,                          /* -msse2 */
  OPT_msse2avx = 1282,                       /* -msse2avx */
  OPT_msse3 = 1283,                          /* -msse3 */
  OPT_msse4 = 1284,                          /* -msse4 */
  OPT_msse4_1 = 1285,                        /* -msse4.1 */
  OPT_msse4_2 = 1286,                        /* -msse4.2 */
  OPT_msse4a = 1287,                         /* -msse4a */
  /* OPT_msse5 = 1288, */                    /* -msse5 */
  OPT_msseregparm = 1289,                    /* -msseregparm */
  OPT_mssse3 = 1290,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1291,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1292,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1293,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1294,            /* -mstringop-strategy= */
  OPT_mstv = 1295,                           /* -mstv */
  OPT_mtbm = 1296,                           /* -mtbm */
  OPT_mtls_dialect_ = 1297,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1298,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1299,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1300,                         /* -mtune= */
  OPT_muclibc = 1301,                        /* -muclibc */
  OPT_mveclibabi_ = 1302,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1303,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1304,                    /* -mvzeroupper */
  OPT_mx32 = 1305,                           /* -mx32 */
  OPT_mxop = 1306,                           /* -mxop */
  OPT_mxsave = 1307,                         /* -mxsave */
  OPT_mxsavec = 1308,                        /* -mxsavec */
  OPT_mxsaveopt = 1309,                      /* -mxsaveopt */
  OPT_mxsaves = 1310,                        /* -mxsaves */
  OPT_n = 1311,                              /* -n */
  OPT_no_canonical_prefixes = 1312,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1313,              /* -no-integrated-cpp */
  OPT_no_pie = 1314,                         /* -no-pie */
  OPT_nocpp = 1315,                          /* -nocpp */
  OPT_nodefaultlibs = 1316,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1317,                   /* -nostartfiles */
  OPT_nostdinc = 1318,                       /* -nostdinc */
  OPT_nostdinc__ = 1319,                     /* -nostdinc++ */
  OPT_nostdlib = 1320,                       /* -nostdlib */
  OPT_o = 1321,                              /* -o */
  OPT_p = 1322,                              /* -p */
  OPT_pass_exit_codes = 1323,                /* -pass-exit-codes */
  /* OPT_pedantic = 1324, */                 /* -pedantic */
  OPT_pedantic_errors = 1325,                /* -pedantic-errors */
  OPT_pg = 1326,                             /* -pg */
  OPT_pie = 1327,                            /* -pie */
  OPT_pipe = 1328,                           /* -pipe */
  OPT_posix = 1329,                          /* -posix */
  OPT_print_file_name_ = 1330,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1331,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1332,          /* -print-multi-directory */
  OPT_print_multi_lib = 1333,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1334,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1335,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1336,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1337,               /* -print-prog-name= */
  OPT_print_search_dirs = 1338,              /* -print-search-dirs */
  OPT_print_sysroot = 1339,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1340,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1341,                        /* -profile */
  OPT_pthread = 1342,                        /* -pthread */
  OPT_quiet = 1343,                          /* -quiet */
  OPT_r = 1344,                              /* -r */
  OPT_rdynamic = 1345,                       /* -rdynamic */
  OPT_remap = 1346,                          /* -remap */
  OPT_s = 1347,                              /* -s */
  OPT_save_temps = 1348,                     /* -save-temps */
  OPT_save_temps_ = 1349,                    /* -save-temps= */
  OPT_shared = 1350,                         /* -shared */
  OPT_shared_libgcc = 1351,                  /* -shared-libgcc */
  /* OPT_specs = 1352, */                    /* -specs */
  OPT_specs_ = 1353,                         /* -specs= */
  OPT_static = 1354,                         /* -static */
  OPT_static_libasan = 1355,                 /* -static-libasan */
  OPT_static_libgcc = 1356,                  /* -static-libgcc */
  OPT_static_libgfortran = 1357,             /* -static-libgfortran */
  OPT_static_libgo = 1358,                   /* -static-libgo */
  OPT_static_liblsan = 1359,                 /* -static-liblsan */
  OPT_static_libmpx = 1360,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1361,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1362,               /* -static-libstdc++ */
  OPT_static_libtsan = 1363,                 /* -static-libtsan */
  OPT_static_libubsan = 1364,                /* -static-libubsan */
  /* OPT_std_c__03 = 1365, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1366, */                /* -std=c++0x */
  OPT_std_c__11 = 1367,                      /* -std=c++11 */
  OPT_std_c__14 = 1368,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1369, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1370, */                /* -std=c++1y */
  OPT_std_c__1z = 1371,                      /* -std=c++1z */
  OPT_std_c__98 = 1372,                      /* -std=c++98 */
  OPT_std_c11 = 1373,                        /* -std=c11 */
  /* OPT_std_c1x = 1374, */                  /* -std=c1x */
  /* OPT_std_c89 = 1375, */                  /* -std=c89 */
  OPT_std_c90 = 1376,                        /* -std=c90 */
  OPT_std_c99 = 1377,                        /* -std=c99 */
  /* OPT_std_c9x = 1378, */                  /* -std=c9x */
  OPT_std_f2003 = 1379,                      /* -std=f2003 */
  OPT_std_f2008 = 1380,                      /* -std=f2008 */
  OPT_std_f2008ts = 1381,                    /* -std=f2008ts */
  OPT_std_f95 = 1382,                        /* -std=f95 */
  OPT_std_gnu = 1383,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1384, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1385, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1386,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1387,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1388, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1389, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1390,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1391,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1392,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1393, */                /* -std=gnu1x */
  ...
  OPT_std_legacy = 1403,                     /* -std=legacy */
  OPT_symbolic = 1404,                       /* -symbolic */
  OPT_t = 1405,                              /* -t */
  OPT_time = 1406,                           /* -time */
  OPT_time_ = 1407,                          /* -time= */
  OPT_tno_android_cc = 1408,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1409,                 /* -tno-android-ld */
