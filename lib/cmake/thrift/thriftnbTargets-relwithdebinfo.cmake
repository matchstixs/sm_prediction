...
set_target_properties(thriftnb::thriftnb PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libthriftnb.so.0.14.1"
  IMPORTED_SONAME_RELWITHDEBINFO "libthriftnb.so.0.14.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS thriftnb::thriftnb )
list(APPEND _IMPORT_CHECK_FILES_FOR_thriftnb::thriftnb "${_IMPORT_PREFIX}/lib/libthriftnb.so.0.14.1" )
