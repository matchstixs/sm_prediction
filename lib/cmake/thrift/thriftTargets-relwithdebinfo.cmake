...
set_target_properties(thrift::thrift PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libthrift.so.0.14.1"
  IMPORTED_SONAME_RELWITHDEBINFO "libthrift.so.0.14.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS thrift::thrift )
list(APPEND _IMPORT_CHECK_FILES_FOR_thrift::thrift "${_IMPORT_PREFIX}/lib/libthrift.so.0.14.1" )
